...
var lightAppColors = AppColors(
    ...
    swoopTopFg: Color(0xff8ac78b),
    swoopTopBg: Color(0xffc6efc6),
    swoopBottomFg: Color(0xff89c58a),
    swoopBottomBg: Color(0xff478047),
    delete: _colorRed,
...
var darkAppColors = AppColors(
    ...
    gradTop: _colorGreenGradTop,
    swoopTopFg: _colorGreen,
    swoopTopBg: _colorGreenDark,
    swoopBottomFg: _colorGreen,
    swoopBottomBg: _colorGreenDark,
    delete: _colorRed,
    highlight: _colorGreen,
    unread: _colorRed,
    star: _colorYellow,
